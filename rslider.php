...
if (!$_GET['rs_id'] && !$_POST['rs_id'])
{
		...
		<?php						  
				...
				?>
							<tr>
								<td align="center"><a href="<?php echo $currurl;?>&rs_id=<?php echo $row->rs_id;?>&rs_action=rs_edit"><img src="<?php echo WP_PLUGIN_URL;?>/m-vslider/edit.png"></a>&nbsp;&nbsp;<a href="<?php echo $currurl;?>&rs_id=<?php echo $row->rs_id;?>&rs_action=rs_remove"><img src="<?php echo WP_PLUGIN_URL;?>/m-vslider/remove.png"></a></td>
